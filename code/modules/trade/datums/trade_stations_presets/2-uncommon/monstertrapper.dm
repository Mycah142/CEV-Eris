...
/datum/trade_station/trapper
	name_pool = list(
		"EXTV \'Armitage\'" = "Exterminator Vessel \'Armitage\': \"Greetings, CEV Theseus. We\'re in a bit of a rough spot at the moment. Got any traps to spare?\"",
	)
	...
	offer_types = list(
		/obj/item/mine/improv = offer_data("makeshift mine", 600, 0),
		/obj/item/mine/old = offer_data("old landmine", 1200, 0),
		/obj/item/beartrap/makeshift = offer_data("makeshift mechanical trap", 600, 0),
		/obj/item/grenade/sonic = offer_data("sonic lure grenades", 450, 5),
		/obj/item/flamethrower = offer_data("flamethrowers (urgent)", 500, 8),
