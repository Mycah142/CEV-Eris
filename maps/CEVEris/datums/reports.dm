...
/datum/computer_file/report/recipient/crew_transfer/generate_fields()
	...
	add_field(/datum/report_field/instruction, "CEV Theseus - Office of the First Officer")
...
/datum/computer_file/report/recipient/sec/investigation/generate_fields()
	..()
	add_field(/datum/report_field/instruction, "Ironhammer Division CEV Theseus")
...
/datum/computer_file/report/recipient/docked/generate_fields()
	..()
	add_field(/datum/report_field/instruction, "CEV Theseus Supply and Hangar Management Department")
...
/datum/computer_file/report/recipient/fauna/generate_fields()
	..()
	add_field(/datum/report_field/instruction, "CEV Theseus Expeditions")
...
/datum/computer_file/report/recipient/nt/proc/add_header()
	add_field(/datum/report_field/simple_text, "Vessel", "CEV Theseus")
	add_field(/datum/report_field/date, "Date")
	add_field(/datum/report_field/time, "Time")
...
/datum/computer_file/report/recipient/nt/incident/ship
	form_name = "CEV-3203"
	title = "CEV Theseus Ship Incident Report"
	available_on_ntnet = 1
...
/datum/computer_file/report/recipient/nt/incident/personnel
	form_name = "CEV-3205"
	title = "CEV Theseus Personnel Incident Report"
	available_on_ntnet = 1
...
/datum/computer_file/report/recipient/nt/incident/asset
	form_name = "CEV-3201"
	title = "CEV Theseus Asset Incident Report"
	available_on_ntnet = 1

/datum/computer_file/report/recipient/nt/incident/asset/generate_fields()
	..()
	add_field(/datum/report_field/pencode_text, "CEV Theseus Employee Injuries")
	add_field(/datum/report_field/pencode_text, "CEV Theseus Assets Lost")
	add_signatures()
...
/datum/computer_file/report/recipient/nt/incident/synth
	form_name = "CEV-3213X"
	title = "CEV Theseus Synthetic Incident Report"
	available_on_ntnet = 1
...
/datum/computer_file/report/recipient/nt/incident/crew
	form_name = "CEV-3241"
	title = "CEV Theseus Ship Crew/Employee Incident Report"
	available_on_ntnet = 1
...
/datum/computer_file/report/recipient/nt/visa
	form_name = "CEV-0952"
	title = "CEV Theseus ID or PDA Request Form"
	available_on_ntnet = 1
...
/datum/computer_file/report/recipient/sol/audit
	form_name = "CDA-AG-12"
	title = "CEV Theseus Department Audit"
	available_on_ntnet = 1
